...
Output <- sim(10, n=list(200, 150), model=bivHetModel, generate=bivHetFit, mxFit=TRUE)
...
dat1 <- generateOpenMx(bivHetModel, n=list(100, 150))
dat2 <- generateOpenMx(bivHetFit, n=list(100, 150))
dat3 <- generateOpenMx(bivHomModel, n=list(100, 150))
dat4 <- generateOpenMx(bivHomFit, n=list(100, 150))

out1 <- analyzeOpenMx(bivHetModel, dat1, groupLab = "group")
out2 <- analyzeOpenMx(bivHetModel, dat2, groupLab = "group")
out3 <- analyzeOpenMx(bivHomModel, dat3, groupLab = "group")
out4 <- analyzeOpenMx(bivHomModel, dat4, groupLab = "group")

outSat1 <- analyzeSaturateOpenMx(dat1, groupLab = "group")
outSat2 <- analyzeSaturateOpenMx(dat2, groupLab = "group")
outSat3 <- analyzeSaturateOpenMx(dat3, groupLab = "group")
outSat4 <- analyzeSaturateOpenMx(dat4, groupLab = "group")

outNull1 <- analyzeNullOpenMx(dat1, groupLab = "group")
outNull2 <- analyzeNullOpenMx(dat2, groupLab = "group")
outNull3 <- analyzeNullOpenMx(dat3, groupLab = "group")
outNull4 <- analyzeNullOpenMx(dat4, groupLab = "group")

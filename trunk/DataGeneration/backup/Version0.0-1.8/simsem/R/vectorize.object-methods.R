...
setMethod("vectorize.object", signature(object="blankReducedMatrixSet", labels="labelsSet"), definition= function(object, labels) {
		result <- NULL
...
#Arguments: 
#	object:	blankReducedMatrixSet.c of values that wish to vectorize. Now, use in parameter estimates or SE from simAnalysis.c

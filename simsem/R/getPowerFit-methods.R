...
setMethod("getPowerFit", signature(altObject = "data.frame"), definition = function(altObject, 
...
setMethod("getPowerFit", signature(altObject = "SimResult"), definition = function(altObject, 
    cutoff, revDirec = FALSE, usedFit = NULL) {
...
setMethod("getPowerFit", signature(altObject = "matrix"), definition = function(altObject, 
    cutoff, revDirec = FALSE, usedFit = NULL) {

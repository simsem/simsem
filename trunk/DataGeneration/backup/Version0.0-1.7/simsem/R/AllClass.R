...
# Attributes:
#	Tag:			Model type (CFA, Path, or SEM)
#	Data:		simData.c that save the model for data generation
#	Model:		simModel.c that save the model for data analysis
#	Replication:	Number of replication
#	Output:		data.frame.c of fit indices of each replication

...
setMethod("run",
    ...
    function (object, N = 1) 
    {
        runif(N,object@Lower, object@Upper)
    }
)
#Arguments: 
#	object:	Runif.c object
#	N:		Sample size. The default is 1.
...
#Description: This function will draw numbers from any simDist.c in the element. If there is no simDist.c, the fixed value and starting values will be used.
...
#Arguments: 
#	object:	simMatrixSet.c object
#	simConstraint:	simConstraint.c that save all user-specified constraints.
...
#Return: 	matrixSet.c that is a random sample of all objects in simMatrixSet.c
...
#Arguments: 
#	object:	simMisspecifiedSet.c object
...
#Return: 	misspecifiedSet.c that is a random sample of all objects in simMisspecifiedSet.c
...
#Description: 	The simData will analyze the data and return the simAnalysis.c that saves the result.
#Return: 	simAnalysis.c that saves the result.

...
clean <- function(object) {
	...
	if(!isNullObject(object@paramValue) && (nrow(object@paramValue) > 1)) object@paramValue <- object@paramValue[converged,]
	if(!isNullObject(object@FMI1)) object@FMI1 <- object@FMI1[converged,]
	if(!isNullObject(object@FMI2)) object@FMI2 <- object@FMI2[converged,]

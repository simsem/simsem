...
# Define number of replications and chunks

nRep <- 1000
nChunks <- 20
chunkSize <- nRep / nChunks  # 50

# Use jobid from slurm (possible values = 2*2*2*2*20 = 320)

jobid <- as.numeric(Sys.getenv("SLURM_ARRAY_TASK_ID"))

# Use jobid to calculate cond_id and chunk_id

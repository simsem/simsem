...
setMethod("vectorize.object", signature(object="VirtualRSet", labels="SimLabels"), definition= function(object, labels) {
		result <- NULL
		if(!is.null.object(labels@LX)) result <- c(result, vectorize.object(object@LX, labels@LX))
		if(!is.null.object(labels@LY)) result <- c(result, vectorize.object(object@LY, labels@LY))
		if(!is.null.object(labels@GA)) result <- c(result, vectorize.object(object@GA, labels@GA))
		if(!is.null.object(labels@BE)) result <- c(result, vectorize.object(object@BE, labels@BE))
		if(!is.null.object(labels@PH)) result <- c(result, vectorize.object(object@PH, labels@PH, symmetric=TRUE))
		if(!is.null.object(labels@PS)) result <- c(result, vectorize.object(object@PS, labels@PS, symmetric=TRUE))
		if(!is.null.object(labels@TD)) result <- c(result, vectorize.object(object@TD, labels@TD, symmetric=TRUE))
		if(!is.null.object(labels@TH)) result <- c(result, vectorize.object(object@TH, labels@TH))
		if(!is.null.object(labels@TE)) result <- c(result, vectorize.object(object@TE, labels@TE, symmetric=TRUE))
		if(!is.null.object(labels@KA)) result <- c(result, vectorize.object(object@KA, labels@KA))
		if(!is.null.object(labels@AL)) result <- c(result, vectorize.object(object@AL, labels@AL))
		if(!is.null.object(labels@TX)) result <- c(result, vectorize.object(object@TX, labels@TX))
		if(!is.null.object(labels@TY)) result <- c(result, vectorize.object(object@TY, labels@TY))
		return(result)
	}
)
#Arguments: 

...
# Argument:
#	object: 	simMatrixSet.c that users wish to transform it to freeParamSet.c
# Return: 	freeParamSet.c that saves only free parameters and values of fixed parameters

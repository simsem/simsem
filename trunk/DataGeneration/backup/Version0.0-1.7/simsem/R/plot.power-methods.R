...
# Generic Function: plot.power(object.alt, object.null, ...)
# Argument:
...
setMethod("plot.power", signature(object.alt="data.frame", object.null="vector"), definition=function(object.alt, object.null, used.fit=NULL) {
	plot.cutoff(object.alt, object.null, used.fit=used.fit)
})
#Arguments: 
...
setMethod("plot.power", signature(object.alt="simResult", object.null="vector"), definition=function(object.alt, object.null, used.fit=NULL) {
	plot.cutoff(object.alt@Output, object.null, used.fit=used.fit)
})
#Arguments: 
...
setMethod("plot.power", signature(object.alt="data.frame", object.null="data.frame"), definition=function(object.alt, object.null, alpha, used.fit=NULL) {
	percentile <- 1 - alpha
	cutoff <- find.cutoff(object.null, alpha)
...
setMethod("plot.power", signature(object.alt="simResult", object.null="simResult"), definition=function(object.alt, object.null, alpha, used.fit=NULL) {
	plot.power(object.alt@Output, object.null@Output, alpha, used.fit)
})
#Arguments: 
#	object.alt:		simResult.c of alternative hypothesis that users wish to plot their sampling distribution

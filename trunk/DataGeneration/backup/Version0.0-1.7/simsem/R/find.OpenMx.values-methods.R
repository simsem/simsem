...
#Arguments: 	
#	Parameters:	freeParamSet.c that contains specification of free parameters and all fixed value
#	Starting.Values:	reducedMatrixSet.c containing starting values in each vector and matrix 
#Description: 	This function will put all fixed values in freeParamSet.c into set of starting value matrices
#Return: 	Resulting reducedMatrixSet.c that includes numbers of fixed parameters and starting values of free parameters.

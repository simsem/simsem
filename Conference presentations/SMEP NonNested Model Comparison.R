...
if(all(converged)) {
simAA <- runFit(outA, nRep=nRep, data=datA, analyzeModel=analyzeA, multicore=TRUE)
simAB <- runFit(outA, nRep=nRep, data=datA, analyzeModel=analyzeB, multicore=TRUE)
simAC <- runFit(outA, nRep=nRep, data=datA, analyzeModel=analyzeC, multicore=TRUE)
simAD <- runFit(outA, nRep=nRep, data=datA, analyzeModel=analyzeD, multicore=TRUE)
simBA <- runFit(outB, nRep=nRep, data=datB, analyzeModel=analyzeA, multicore=TRUE)
simBB <- runFit(outB, nRep=nRep, data=datB, analyzeModel=analyzeB, multicore=TRUE)
simBC <- runFit(outB, nRep=nRep, data=datB, analyzeModel=analyzeC, multicore=TRUE)
simBD <- runFit(outB, nRep=nRep, data=datB, analyzeModel=analyzeD, multicore=TRUE)
simCA <- runFit(outC, nRep=nRep, data=datC, analyzeModel=analyzeA, multicore=TRUE)
simCB <- runFit(outC, nRep=nRep, data=datC, analyzeModel=analyzeB, multicore=TRUE)
simCC <- runFit(outC, nRep=nRep, data=datC, analyzeModel=analyzeC, multicore=TRUE)
simCD <- runFit(outC, nRep=nRep, data=datC, analyzeModel=analyzeD, multicore=TRUE)
simDA <- runFit(outD, nRep=nRep, data=datD, analyzeModel=analyzeA, multicore=TRUE)
simDB <- runFit(outD, nRep=nRep, data=datD, analyzeModel=analyzeB, multicore=TRUE)
simDC <- runFit(outD, nRep=nRep, data=datD, analyzeModel=analyzeC, multicore=TRUE)
simDD <- runFit(outD, nRep=nRep, data=datD, analyzeModel=analyzeD, multicore=TRUE)
